...
public class ParameterImpl extends ElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return METACONPackage.Literals.PARAMETER;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, METACONPackage.PARAMETER__TYPE, oldType, type));
	}
	...
	public Action getAction() {
		if (eContainerFeatureID() != METACONPackage.PARAMETER__ACTION)
			return null;
	...
	public NotificationChain basicSetAction(Action newAction, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newAction, METACONPackage.PARAMETER__ACTION, msgs);
		return msgs;
	}
	...
	public void setAction(Action newAction) {
		if (newAction != eInternalContainer()
				|| (eContainerFeatureID() != METACONPackage.PARAMETER__ACTION && newAction != null)) {
