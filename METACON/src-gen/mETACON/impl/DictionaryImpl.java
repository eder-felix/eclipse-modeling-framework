 ...
 * </p>
 * <ul>
 *   <li>{@link mETACON.impl.DictionaryImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DictionaryImpl extends ElementImpl implements Dictionary {
	...
	protected EClass eStaticClass() {
		return METACONPackage.Literals.DICTIONARY;
	}
	...
	public EList<Element> getElement() {
		if (element == null) {
			element = new EObjectContainmentWithInverseEList<Element>(Element.class, this,
					METACONPackage.DICTIONARY__ELEMENT, METACONPackage.ELEMENT__DICTIONARY);
		}
		return element;
	}
